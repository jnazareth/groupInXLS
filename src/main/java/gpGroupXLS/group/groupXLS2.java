...
public class groupXLS2 {
	...
	public File InitializeXLS(String fName, tabGroup tg) {
        File f = null ;
		try {
			...
			// _newFormatting 4/22
			XLSProperties.eHeader.buildHeaders(tg.m_tabSummary.getNumPersons());
	...
	public void ReadXLSBuildGroup2(String configJSON, String xlsGroupFile) {
		try {
			...
			File hFile = InitializeXLS(xlsGroupFile, tg);
